        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12 sitebar">
                ...
                <div class="widget mercado-widget widget-product">
                    ...
                    <div class="widget-content">
                        <ul class="products">
                            @foreach ($popular_producte as $p_producte)
                                <li class="product-item">
                                    <div class="product product-widget-style">
                                        <div class="thumbnnail">
                                            <a href="{{ route('product.details', ['slug' => $p_producte->slug]) }}"
                                                title="{{ $p_producte->name }}">
                                                <figure><img
                                                        src="{{ asset('assets/images/products') }}/{{ $p_producte->image }}"
                                                        alt="{{ $p_producte->name }}"></figure>
                                            </a>
                                        </div>
                                        <div class="product-info">
                                            <a href="{{ asset('assets/images/products') }}/{{ $p_producte->image }}"
                                                class="product-name"><span>{{ $p_producte->regular_price }}}</span></a>
                ...
                <div class="wrap-show-advance-info-box style-1 box-in-site">
                    ...
                    <div class="wrap-products">
                        <div class="products slide-carousel owl-carousel style-nav-1 equal-container" data-items="5"
                            ...
                            @foreach ($related_prodducts as $r_prodducts)
                                <div class="product product-style-2 equal-elem ">
                                    <div class="product-thumnail">
                                        <a href="{{ route('product.details', ['slug' => $r_prodducts->slug]) }}"
                                            title="T-Shirt Raw Hem Organic Boro Constrast Denim">
                                            <figure><img
                                                    src="{{ asset('assets/images/products') }}/{{ $r_prodducts->image }}"
                                                    width="214" height="214" alt="{{ $r_prodducts->name }}"></figure>
                                        </a>
                                    ...
                                    <div class="product-info">
                                        <a href="{{ route('product.details', ['slug' => $r_prodducts->slug]) }}" class="product-name"><span>{{ $r_prodducts->name }}</span></a>
                                        <div class="wrap-price"><span
                                                class="product-price">{{ $r_prodducts->regular_price }}</span></div>
                                    </div>
                                </div>
                            @endforeach
